  ...
  return (
    <div className="my-0 w-fit lg:w-3/4 px-8 lg:px-16 ">
      ...
      >
        ...
        {/* CONTENT HOLDER */}
        <SectionHeader
          tagTitle="Experience before you decide"
          headerTitle="Take a virtual tour of your future home before you visit"
          subTitle="Explore rooms, facilities, and surroundings through a guided video
